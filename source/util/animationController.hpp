...
class AnimationController {
    ...
    std::future<identifier> ReqAddSprite(const std::filesystem::path &file, bool transparent = false, float x = 0.f, float y = 0.f);
    identifier AddTriangle(float x = 0.f, float y = 0.f);
    identifier AddText(const char *text, bool wavy = false, float x = 0.f, float y = 0.f);
    identifier AddSprite(const std::filesystem::path &file, bool transparent = false, float x = 0.f, float y = 0.f);
